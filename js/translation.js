...
'contacts_first_website':'Online since 2002! Visit our ',
'contacts_first_website_link':'first website',
},
...
'contacts_first_website':'Online dal 2002! Visita il nostro ',
'contacts_first_website_link':'primo sito web',
}
};
...
function updateLanguage(lang) {
    ...
    const myfirstWebsite = document.querySelector("#firstWebsite");
    const link = document.createElement("a");
    link.href = "http://www.villarucellai.it/Seconda/index.htm";
    link.target = "_blank";
    ...
    myfirstWebsite.appendChild(link);
}
